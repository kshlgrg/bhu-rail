      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Link href="/government/verification">
            <Button size="sm" className="gap-1.5 font-bold shadow-sm bg-blue-700 hover:bg-blue-800 text-white">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <div className="text-xs text-slate-300 flex items-center gap-2 pt-0.5">
              <span>{user && "department" in user ? user.department : "Revenue & Land Records"}</span>
              <span>•</span>
