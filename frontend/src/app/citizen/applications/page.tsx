...
function CitizenApplicationsContent() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: "Citizen Dashboard", href: "/citizen/dashboard" }, { label: "My Applications" }]}
        badge={<Badge variant="info">{applications.length} Total</Badge>}
        actions={
          <Button onClick={handleOpenWizard} size="sm" className="gap-1.5 font-bold shadow-sm bg-emerald-700 hover:bg-emerald-800 text-white">
        ...
        <div className="space-y-4">
          ...
          {step === 1 && (
            <div className="space-y-3">
              ...
              <div className="pt-3 flex justify-end">
                <Button size="sm" onClick={() => setStep(2)} className="bg-emerald-700 hover:bg-emerald-800 text-white font-bold">
          ...
          {step === 2 && (
            <div className="space-y-3">
              ...
              <div className="pt-3 flex justify-between">
                ...
                <Button size="sm" onClick={() => setStep(3)} className="bg-emerald-700 hover:bg-emerald-800 text-white font-bold">
          ...
          {step === 3 && (
            <div className="space-y-3">
              ...
              <div className="pt-3 flex justify-between">
                ...
                <Button size="sm" onClick={() => setStep(4)} className="bg-emerald-700 hover:bg-emerald-800 text-white font-bold">
                  Next: Review &rarr;
                </Button>
              </div>
            </div>
          ...
          {step === 4 && (
            <div className="space-y-4">
              ...
              <div className="pt-3 flex justify-between">
                ...
                <Button size="sm" onClick={handleSubmitApplication} className="font-bold bg-emerald-700 hover:bg-emerald-800 text-white">
                  Submit Application
                </Button>
              </div>
            </div>
          ...
          {step === 5 && submittedApp && (
            <div className="space-y-4 text-center py-4">
              ...
              <Button size="sm" onClick={() => setIsModalOpen(false)} className="w-full font-bold bg-emerald-700 hover:bg-emerald-800 text-white">
