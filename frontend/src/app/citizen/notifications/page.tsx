...
const INITIAL_CITIZEN_NOTIFICATIONS: CitizenNotification[] = [
  ...
  },
  {
    ...
    read: false,
    action_url: "/citizen/applications",
...
function CitizenNotificationsContent() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: "Citizen Dashboard", href: "/citizen/dashboard" }, { label: "Notifications" }]}
        badge={
          unreadCount > 0 ? (
