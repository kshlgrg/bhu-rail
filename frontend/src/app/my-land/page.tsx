...
export default function MyLandPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="My Land"
        subtitle="View land parcels associated with your profile."
        breadcrumbs={[{ label: "Citizen Dashboard", href: "/dashboard/citizen" }, { label: "My Land" }]}
            ...
            <Card key={parcel.ulpin} className="p-5 border-slate-200 bg-white hover:shadow-md transition-all flex flex-col justify-between">
              ...
              <div className="pt-4 mt-2">
                <Link href={`/parcel/${parcel.ulpin}`}>
                  <Button variant="primary" className="w-full justify-center font-bold text-xs">
